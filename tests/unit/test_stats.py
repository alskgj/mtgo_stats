...
def test_play_rate_calculations(small_tournament: Tournament, classifier: Classifier):
    play_rates = small_tournament.play_rates(classifier)
    assert play_rates == {'Izzet Phoenix': 0.33, 'Rakdos Vampires': 0.67}


def test_only_one_deck_play_rate_calculations(phoenix_tournament: Tournament, classifier: Classifier):
...
# ])
# def test_win_rate_calculations(input_tournaments, win_rate, request, classifier: Classifier):
...
# ])
# def test_play_rates_calculations(input_tournaments, play_rate, request, classifier: Classifier):
#     # resolve tournament fixtures
#     input_tournaments = [request.getfixturevalue(tournament) for tournament in input_tournaments]
#
...
#
#
# def test_old_tournaments_calculations(phoenix_tournament, old_small_tournament, classifier: Classifier):
